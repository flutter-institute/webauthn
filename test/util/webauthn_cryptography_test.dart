...
// prefix: 3045022100 (Sequence (0x30) of 0x45 bytes, Integer (0x20) of length 0x21 bytes, (0x00) sign bit we can just skip)
...
void main() {
  group('verification', () {
    test('verifies external signature correctly', () {
      ...
      final result = WebauthnCrytography.verifySignature(
          pubKey, ui(testString.codeUnits), signature);
  ...
  group('signing', () {
    test('signs value correctly', () {
      ...
      final result = WebauthnCrytography.performSignature(
      ...
      final verifiedItself = WebauthnCrytography.verifySignature(
          pubKey, ui(testString.codeUnits), result);
