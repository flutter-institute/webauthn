...
// prefix: 3045022100 (Sequence (0x30) of 0x45 bytes, Integer (0x20) of length 0x21 bytes, (0x00) sign bit)
...
void main() {
  ...
  group('signing', () {
    test('signs value correctly', () {
      ...
      expect(result, hasLength(64 + 6)); // sig + DER chars
  ...
  group('signatures', () {
    ...
    test(
      ...
      () {
        ...
        expect(remoteKey, equals(signatureDER));
      },
    );
  });
