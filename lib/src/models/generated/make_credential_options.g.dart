...
MakeCredentialOptions _$MakeCredentialOptionsFromJson(Map json) =>
    MakeCredentialOptions(
      clientDataHash: const Uint8ListConverter().fromJson(
      ...
      credTypesAndPubKeyAlgs: (json['credTypesAndPubKeyAlgs'] as List<dynamic>)
          .map(
            (e) => const CredTypePubKeyAlgoPairConverter().fromJson(e as List),
          )
          .toList(),
      excludeCredentialDescriptorList:
          (json['excludeCredentials'] as List<dynamic>?)
              ?.map(
                (e) => PublicKeyCredentialDescriptor.fromJson(
...
Map<String, dynamic> _$MakeCredentialOptionsToJson(
  ...
  'clientDataHash': const Uint8ListConverter().toJson(instance.clientDataHash),
