...
AssertionResponseData _$AssertionResponseDataFromJson(
  Map json,
  ...
  userHandle: const Uint8ListConverter().fromJson(json['userHandle'] as String),
);

Map<String, dynamic> _$AssertionResponseDataToJson(
  AssertionResponseData instance,
) => <String, dynamic>{
  'authenticatorData': const Uint8ListConverter().toJson(
